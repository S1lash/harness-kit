...
| `tests/` | Re-runs by machine what was once verified by hand: the manifest reader, the retirement guard, the updater end to end against a real remote, and the session-start tool. | `python3 -m unittest discover -s tools/tests` |
